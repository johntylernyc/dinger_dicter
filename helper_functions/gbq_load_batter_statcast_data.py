...
def load_batter_data_to_gbq(daily_statcast_data_csv, project_id, dataset_name, statcast_table_name, json_key_path):
    ...
    try:
        ...
        with open(daily_statcast_data_csv, 'rb') as source_file:
            ...
            job.result()
            # print a message
            print('Loaded {} rows into {}:{}.'.format(job.output_rows, dataset_name, statcast_table_name))
...
if __name__ == '__main__':
    ...
    statcast_table_name = 'daily_statcast_data'
    ...
    # call the function
    load_batter_data_to_gbq(daily_statcast_data_csv, project_id, dataset_name, statcast_table_name, json_key_path)